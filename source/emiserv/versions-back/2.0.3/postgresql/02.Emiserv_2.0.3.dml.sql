...
INSERT INTO ems_config (key, description_key, group_code, position, source_property, type_code, requereix_reinici) VALUES ('es.caib.emiserv.security.mappableRoles', 'propietat.security.mappableRoles', 'GENERAL', '5', 'DATABASE', 'TEXT', 'true');
INSERT INTO ems_config (key, description_key, group_code, position, source_property, type_code, requereix_reinici) VALUES ('es.caib.emiserv.security.useResourceRoleMappings', 'propietat.security.useResourceRoleMappings', 'GENERAL', '6', 'DATABASE', 'BOOL', 'true');
